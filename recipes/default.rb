...
if ! node['scripts']['before_configure'].nil?
    node.set['scripts']['position'] = 'before_configure'
...
if ! node['scripts']['after_configure'].nil?
    node.set['scripts']['position'] = 'after_configure'
  include_recipe "skystack::script"
end